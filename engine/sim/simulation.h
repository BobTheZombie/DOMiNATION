...
struct SimulationStats {
  ...
  uint32_t mountainCombatEvents{0};
  uint32_t passControlEvents{0};
  uint32_t tunnelMilitaryMoves{0};
  uint32_t mountainFortBonusEvents{0};
  uint32_t chokepointContests{0};
  uint32_t mountainRouteSelections{0};
  ...
  uint32_t russiaContentUsage{0};
  uint32_t usaContentUsage{0};
  uint32_t japanContentUsage{0};
  uint32_t euContentUsage{0};
  uint32_t ukContentUsage{0};
  uint32_t egyptContentUsage{0};
  uint32_t tartariaContentUsage{0};
  uint32_t armageddonActive{0};
  uint32_t nuclearUseCountTotal{0};
  uint32_t armageddonTriggerTick{0};
  uint32_t lastManStandingModeActive{0};
...
struct World {
  ...
  uint32_t egyptContentUsage{0};
  uint32_t tartariaContentUsage{0};
  bool armageddonActive{false};
  uint32_t armageddonTriggerTick{0};
  bool lastManStandingModeActive{false};
  uint16_t armageddonNationsThreshold{2};
  uint16_t armageddonUsesPerNationThreshold{2};
  std::vector<uint16_t> nuclearUseCountByPlayer;
  uint32_t nuclearUseCountTotal{0};
  uint32_t civDoctrineSwitches{0};
  float civIndustryOutput{0.0f};
  float civLogisticsBonusUsage{0.0f};
