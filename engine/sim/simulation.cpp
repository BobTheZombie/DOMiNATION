...
void tick_world(World& w, float dt) {
  ...
  gLastStats.aiExpansionEarlyCount = w.aiExpansionEarlyCount;
  gLastStats.aiExpansionRegionalCount = w.aiExpansionRegionalCount;
  gLastStats.aiExpansionIndustrialCount = w.aiExpansionIndustrialCount;
  gLastStats.aiExpansionCrisisCount = w.aiExpansionCrisisCount;
  gLastStats.aiExpansionArmageddonCount = w.aiExpansionArmageddonCount;
  gLastStats.aiCounterResponseEvents = w.aiCounterResponseEvents;
  gLastStats.aiRailUsageEvents = w.aiRailUsageEvents;
  gLastStats.aiLogisticsDisruptedFronts = w.aiLogisticsDisruptedFronts;
  gLastStats.aiIndustrialActivationCount = w.aiIndustrialActivationCount;
  gLastStats.aiIndustrialActivationTick = w.aiIndustrialActivationTick;
  gLastStats.aiDeterrencePostureChanges = w.aiDeterrencePostureChanges;
  gLastStats.aiOperationLaunches = w.aiOperationLaunches;
...
uint64_t state_hash(const World& w) {
  ...
  hash_u32(h, w.aiExpansionEarlyCount);
  hash_u32(h, w.aiExpansionRegionalCount);
  hash_u32(h, w.aiExpansionIndustrialCount);
  hash_u32(h, w.aiExpansionCrisisCount);
  hash_u32(h, w.aiExpansionArmageddonCount);
  hash_u32(h, w.aiCounterResponseEvents);
  hash_u32(h, w.aiRailUsageEvents);
  hash_u32(h, w.aiLogisticsDisruptedFronts);
  hash_u32(h, w.aiIndustrialActivationCount);
