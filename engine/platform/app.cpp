...
nlohmann::json save_world_json(const dom::sim::World& w) {
  ...
  j["guardiansDiscovered"] = w.guardiansDiscovered; j["guardiansSpawned"] = w.guardiansSpawned; j["guardiansJoined"] = w.guardiansJoined; j["guardiansKilled"] = w.guardiansKilled;
...
bool load_world_json(const nlohmann::json& j, dom::sim::World& w, std::string& err) {
  ...
  w.guardiansDiscovered = j.value("guardiansDiscovered",0u); w.guardiansSpawned = j.value("guardiansSpawned",0u); w.guardiansJoined = j.value("guardiansJoined",0u); w.guardiansKilled = j.value("guardiansKilled",0u);
